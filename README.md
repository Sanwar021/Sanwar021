...
I am **Sanwar Islam**, a **Machine Learning Engineer, AI Researcher, and Full-Stack Developer** from Dhaka, Bangladesh.

My work focuses on **Computer Vision, Medical AI, Deep Learning, and real-world healthcare technology**. I have published **9 research papers** across **IEEE, Springer, and SCOPUS-indexed venues**, and I am currently building **Upasham Prescription**, a modern medical platform powered by full-stack engineering and AI-assisted healthcare workflows.
...
focus: Machine Learning, Medical AI, Computer Vision, Full-Stack Development
  ...
  <tr>
    ...
    <td style="background-color:#0A1F1C;">
      ...
      <p>
        ...
        <b>Venue:</b> ICDMIS 2024 · ECMT India × Universitas Al Asyariah Mandar, Indonesia<br/>
        <b>Publication:</b> Springer LNNS Series · SCOPUS Indexed<br/>
        <b>Supervisor:</b> Prof. Dr. Ahmed Wasif Reza
      </p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="33%">
      <h2>9</h2>
      <b>Publications</b><br/>
      <sub>IEEE · Springer · SCOPUS</sub>
    </td>
    <td align="center" width="33%">
      <h2>3</h2>
      <b>Citations</b><br/>
      <sub>Google Scholar Verified</sub>
    </td>
    <td align="center" width="33%">
      <h2>2</h2>
      <b>Best Paper Awards</b><br/>
      <sub>ICDMIS 2024 · Springer</sub>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Deep Learning, Computer Vision, Medical Imaging, CNN, 3D-CNN, Disease Classification, Research Modeling, Data Analysis.</p>
    </td>
    <td width="50%">
      <h3>💻 Full-Stack Development</h3>
      <p>React, Vite, TypeScript, JavaScript, Go, PostgreSQL, API Development, Dashboard Systems, SaaS-style Platforms.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🏥 Medical AI</h3>
      <p>Glioblastoma prediction, tumor analysis, health-data workflows, AI-assisted diagnostics, clinical decision-support concepts.</p>
    </td>
    <td width="50%">
      <h3>🚀 Product Engineering</h3>
      <p>Building practical tools with clean UI, reliable backend systems, database workflows, and real-world deployment focus.</p>
    </td>
  </tr>
</table>
...
| # | Research Paper | Field | Year | Status |
|---|---|---|---|---|
| 01 | Measuring Accuracy of Different ML Algorithms on Expectations and Experiences of University Students | Machine Learning | 2025 | 1 citation |
| 02 | Earthquake Magnitude Prediction: A Survey on ML Models, Datasets, Techniques, Challenges, and Future Directions | Deep Learning | 2024 | 1 citation |
| 03 | Detection of Sugarcane Leaf Diseases Using Custom CNN and ResNet50 | Computer Vision | 2024 | 1 citation |
| 04 | Prediction of Glioblastoma Using Data Mining & AI | Medical AI | 2025 | Published |
| 05 | Deep Learning-Based Classification of Coconut Leaf Diseases Using Optimized CNN Models | Deep Learning | 2025 | Published |
| 06 | Green Machine Learning: Energy-Aware Approaches for Sustainable Computing | Sustainable AI | 2025 | Published |
| 07 | Detection of Lemon Leaf Diseases Using Inception V3-Based Machine Learning Model | Computer Vision | 2025 | Published |
| 08 | Forecasting Air Quality: A Comprehensive Survey of Air Pollution Prediction Methods and Applications | Data Science | 2025 | Published |
| 09 | Prediction of Glioblastoma Using 3D-CNN | Medical AI | 2024 | 🏆 Best Paper Award |
...
<img width="100%" src="https://github-profile-trophy.vercel.app/?username=Sanwar021&theme=darkhub&no-frame=true&no-bg=true&margin-w=8&column=7&rank=SECRET,SSS,SS,S,AAA,AA,A,B,C" alt="GitHub Trophies"/>
...
<picture>
  ...
  <img alt="GitHub Contribution Snake" src="https://github.com/Sanwar021/Sanwar021/raw/output/github-contribution-grid-snake-dark.svg" />
</picture>
