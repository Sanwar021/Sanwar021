...
<!-- SOCIAL BADGES -->
[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-sanwarul--ai--folio-FF7B00?style=for-the-badge&logoColor=white)](https://sanwarul-ai-folio.vercel.app/)
...
class SanwarIslam:
    def __init__(self):
        ...
        self.title       = "Software Engineer | Data Scientist | CSE Graduate"
        self.university  = "East West University"
        self.email       = "std.ewubd.edu (verified)"
        self.roles       = ["Data Scientist", "Web Developer", "Researcher"]
        self.research    = ["ML & DL", "Data Mining", "AI", "Software Development"]
        self.frontend    = ["React", "Vite", "JavaScript", "HTML5", "CSS3"]
    ...
    def say_hi(self):
        print("Let's collaborate and build something impactful! 🚀")
